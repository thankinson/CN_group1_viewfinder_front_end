...
export const Login = ({ user, setUser }) => {
    ...
    return (
        ...
        <div id="transition">
                <svg id='scrolldown-arrow' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-down" viewBox="0 0 16 16">
        ...
        <div className="blurb-section">
            <div className="blurb-container">
                ...
                <p>ViewFinder is an easy-to-use service that will find what streaming services, <i>and where</i> to stream your favourite films.</p>
                <p>Do you use Netflix, Amazon Prime, or Disney Plus? Do you use a VPN to broaden your viewing options? ViewFinder will quickly tell you where in the world you need to be (wink wink) to watch your favourite films right now!</p>
